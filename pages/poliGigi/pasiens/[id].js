...
const DetilPasien=({id,authorization})=>{
      ...
      if(pilihPasien.poli_gigi!=null){
          console.log(pilihPasien);
           if(pilihPasien.rawat_inap!=null){
            ...
            setFormValue({...formValue,['diagnosis']:pilihPasien.poli_gigi.diagnosis,
  ...
  useEffect(()=>{
    ...
    const toggleBoxRujukFunc=(toggle)=>{
       if(toggle==false){ 
        setStyleBoxForm({...styleBoxForm,['langsung']:{display:'block'},
                                        ['rujuk']:{display:'none'}});
        setToggleRujuk(false);
       }else{
        setStyleBoxForm({...styleBoxForm,['langsung']:{display:'none'},
          ['rujuk']:{display:'block'}});
          setToggleRujuk(true);
       }
  ...
  const hapusDataPoliGigi=()=>{
    ...
    axiosClient.post('Poligigi/hapusDataPoliGigi',
      ...
      keterangan:formValue.keterangan
        ...
        console.log(data);
        Swal.close();
        dispatch({type:'STORE_DATA_POLI_GIGI',
    ...
    //BATAS FUNGSI CRUD
           ...
           const exportExcelFile=(logo)=>{
             ...
             if(pilihPasien.rawat_inap!==null){
               ...
               sheet[0].mergeCells('E19:H19');
               sheet[0].getCell('E19').value=pilihPasien.poli_gigi.diagnosis_pengobatan;
               sheet[0].getCell('E19').font={name: 'Times New Roman', family: 4, size: 10,bold: false}
               sheet[0].getCell('E19').alignment ={vertical:"middle",horizontal:"left"};
               sheet[0].getCell('E19').border = {
                   top: {style:'thin'},
               ...
               sheet[0].mergeCells('E20:H20');
               sheet[0].getCell('E20').value=pilihPasien.poli_gigi.diagnosis;
               sheet[0].getCell('E20').font={name: 'Times New Roman', family: 4, size: 10,bold: false}
               sheet[0].getCell('E20').alignment ={vertical:"middle",horizontal:"left"};
               sheet[0].getCell('E20').border = {
                   top: {style:'thin'},
               ...
               sheet[0].mergeCells('E21:H21');
               sheet[0].getCell('E21').value=pilihPasien.poli_gigi.resep_obat;
               sheet[0].getCell('E21').font={name: 'Times New Roman', family: 4, size: 10,bold: false}
               sheet[0].getCell('E21').alignment ={vertical:"middle",horizontal:"left"};
               sheet[0].getCell('E21').border = {
                   top: {style:'thin'},
                             ...
                             <div >
                                  {
                                    pilihPasien!=null?(
                                        pilihPasien.poli_gigi==null?(
                                          <button className="btn btn-primary" onClick={tambahDataPoliGigi}>Tambah</button>
                                        ):(
                                          <div>
                                              <div className="w-25 d-inline-block me-2" >
                                                  <button className="btn btn-success w-100" onClick={ubahDataPoliGigi}>Ubah</button>
                                              </div>
                                              <div className=" d-inline-block" style={{width:"30%"}} >
                                                     <button className="btn btn-danger w-100" onClick={hapusDataPoliGigi}>Hapus</button>
                                              </div>
